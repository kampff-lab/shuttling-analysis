...
from infotables import stable, unstable
...
infostable = stable(info)
infomanip = unstable(info)

# Plot data
f, ((sc,sl),(mc,ml)) = plt.subplots(2,2)
activitysummary(control(infostable),rr,lpoke,rpoke,vcr,cr,ax=sc)
activitysummary(anylesion(infostable),rr,lpoke,rpoke,vcr,cr,ax=sl)
activitysummary(control(infomanip),rr,lpoke,rpoke,vcr,cr,ax=mc)
activitysummary(anylesion(infomanip),rr,lpoke,rpoke,vcr,cr,ax=ml)
